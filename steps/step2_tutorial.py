    ...
    for i in range(len(gradients) - 1):
        ...
        if category:
            categoryContent = f"""
                ...
                # Background circle
                <circle cx="1275" cy="90" r="30" fill="{color}"/>
